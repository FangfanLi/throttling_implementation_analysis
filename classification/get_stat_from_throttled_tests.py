'''
This script goes through all clients in a directory.

Get their stat for classification, namely
# avg_client_tputs_original, avg_server_tputs_original,
# stdev_client_tputs_original, stdev_server_tputs_original,
# loss_rate_original, loss_rate_inverted

Save all these stat as dictionaries separated by uniqueID separated by ISP_replay
into test_stat_per_carrier_replay

test_stat_per_carrier_replay[ISP_replay][uniqueID] = test_stat
'''
